<template>
    <div class="listado-container">
        ...
        <div class="listado-header">
            ...
            <router-link to="/agregar-punto" class="boton-agregar" aria-label="Agregar nuevo punto contaminado">
                    ...
                    <tr v-for="(punto, index) in puntos" :key="punto.id">
                        ...
                        <td class="col-acciones">
                            <div class="acciones-grupo">
                                <router-link :to="`/punto/${punto.id}`" class="btn-ver"
                                    aria-label="Ver detalles de {{ punto.nombre }}" title="Ver detalles">
                                    Ver
                                </router-link>
                                <button @click="abrirModalEliminar(punto)" class="btn-eliminar"
