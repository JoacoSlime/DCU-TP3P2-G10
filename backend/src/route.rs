...
pub fn create_router(app_state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/api/collaborators/get", get(get_collaborator))
        .route("/api/measures/get", get(get_measure))
        .route("/api/measures/list", get(list_measures))
        .route("/api/spots/get", get(get_spot))
        .route("/api/spots/list", get(list_spots))
        .route("/api/spots/measures", get(get_measures))
        // Collaborator routes
        .route(
            "/api/auth/logout",
